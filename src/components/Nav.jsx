  ...
  return (
    <>
      <div className={`nav ${menu ? "open" : ""}`}>
        <div className="nav__menu">
          <a aria-label="home" href="/home">
            <img className="menu__logo" src='/public/img/header/LOGO.svg' loading="lazy" alt="logo" />
          </a>
          <nav>
            <ul>
        ...
        <section class="nav__rrss">
          <ul class="rrss__rs">
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/brayancardenas34"
                aria-label="linkedin"
                target="_blank"
                rel="noreferrer noopener"
              >
      ...
      <div onClick={toggleMenu} className={`hamburger ${menu ? "open" : ""}`}>
        <div className="hamburger__line hamburger__line--half hamburger__line--start"></div>
        <div className="hamburger__line"></div>
        <div className="hamburger__line hamburger__line--half hamburger__line--end"></div>
      </div>
    </>
  );
}
